...
// Wi-Fi 
const char* ssid = "MWFA";
const char* password = "MWFA1212";
const char* serverUrl = "http://192.168.0.102:3000/api/sensor-data";
const char* checkLedUrl = "http://192.168.0.102:3000/api/check-led-d2";
